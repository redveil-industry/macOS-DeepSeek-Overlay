...
def set_custom_launcher_trigger(app):
    ...
    container_view.layer().setBackgroundColor_(app.drag_area.layer().backgroundColor())
    ...
    trigger_display_height = trigger_display_container_height
    trigger_display_x = 0
    ...
    # Create the trigger display container

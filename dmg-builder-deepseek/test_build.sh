...
APP_NAME="macos-deepseek-overlay"
...
python setup_deepseek.py py2app --arch "$PY2APP_ARCH" --dist-dir="dmg-builder-deepseek/dist" --bdist-base="dmg-builder-deepseek/build"
...
codesign --force --sign - dmg-builder-deepseek/dist/macos-deepseek-overlay.app

# Exit the directory.
popd >/dev/null


echo "Built app at dmg-builder-deepseek/dist/${APP_NAME}.app"